...
# # Hardcoded input for testing with named parameters
# target, failure = predict(
#     air_temp=297777708.9,
#     process_temp=3097777770.1,
#     rotational_speed=2807777777701,
#     torque=5474477.1,
#     tool_wear=1047473,
#     type_value='L'  # Example Type
# )

# print("Predicted Target:", target)
# print("Predicted Failure Type:", failure)
